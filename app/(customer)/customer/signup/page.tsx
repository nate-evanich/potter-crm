  ...
  return (
    <div className="flex min-h-screen items-center justify-center p-6">
      <div className="w-full max-w-md">
        <Card>
          <h1 className="text-2xl font-bold text-wizard-900 mb-1">Create a customer account</h1>
          <p className="text-sm text-stone-600 mb-6">Sign up to review the practitioners you've worked with.</p>
